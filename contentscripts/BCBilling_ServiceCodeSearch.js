...
async function checkEnabled_BCBilling_ServiceCodeSearch(){
	...
	if(!isEnabled.enabled){
		...
		if (billingServiceCodeSearch_keyboardShortcuts.billingServiceCodeSearch_shortcuts_enabled){
			serviceCodeSearchPage_KeydownListeners(billingServiceCodeSearch_keyboardShortcuts);
		}
...
function serviceCodeSearchPage_KeydownListeners(billingServiceCodeSearch_keyboardShortcuts){
	const confirm_enabled = 
	billingServiceCodeSearch_keyboardShortcuts.billingServiceCodeSearch_shortcuts_confirm_enabled;
	const confirm_keybinding = 
	billingServiceCodeSearch_keyboardShortcuts.billingServiceCodeSearch_shortcuts_confirm_keybinding;
	const cancel_enabled = 
	billingServiceCodeSearch_keyboardShortcuts.billingServiceCodeSearch_shortcuts_cancel_enabled;
	const cancel_keybinding = 
	billingServiceCodeSearch_keyboardShortcuts.billingServiceCodeSearch_shortcuts_cancel_keybinding;
